...
<tr>
<td style="border: none;"><img src="figures/export/full_polariton_heterostructure.png" width="300"/></td>
<td style="border: none;"><img src="figures/export/drivings_branches.png" width="300"/></td>
</tr>
<tr>
<td style="border: none;"><img src="figures/export/reflection_coeff.png" width="300"/></td>
<td style="border: none;"><img src="figures/export/cascade_squares.png" width="300"/></td>
</tr>
</table>

<p style="text-align: center; max-width: 800px; margin: 20px auto;">
<strong></strong> <strong>(a)</strong> Semiconductor heterostructure that serves as a cavity as it confines both light and phononic modes. Exciton confinement is provided by the introduction of quantum wells.
