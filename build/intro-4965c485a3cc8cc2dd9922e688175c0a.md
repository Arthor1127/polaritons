...
Energy schematic of non-localized polariton modes generated from a wedge cavity analog to the system presented at ([Papuccio2025](https://doi.org/10.48550/arXiv.2505.17336)). Polariton mode energies are engineered to have differences similar to the confined phonon's frequency so that coupling between modes is mediated through them.
```
