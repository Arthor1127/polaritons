...
:::{grid-item}
![](figures/export/full_polariton_heterostructure.png)
:::

:::{grid-item}
![](figures/export/drivings_branches.png)
:::

:::{grid-item}
![](figures/export/reflection_coeff.png)
:::

:::{grid-item}
![](figures/export/cascade_squares.png)
:::

::::

**(a)** Semiconductor heterostructure that serves as a cavity as it confines both light and phononic modes. Exciton confinement is provided by the introduction of quantum wells.
**(b)** Schematic of the polariton branches. The reservoir's bottleneck is shown and both driving schemes are contrasted.  
**(c)** Reflection spectrum for the light and sound inside the heterostructure. A stopband with a middle dip is provided by the Bragg reflector overall structure.  
**(d)** Energy schematic of the polariton modes present at a heterostructure with square geometry.
:::
